...
import 'package:kasvil_project/menu/biodata.dart';
import 'package:kasvil_project/menu/nama.dart';
import 'package:kasvil_project/menu/telepon.dart';
...
body : Container(
          color: Color.fromARGB(255, 174, 174, 187),
